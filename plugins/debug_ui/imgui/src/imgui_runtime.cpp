...
bool init_vulkan() {
  ...
  }
  {
    ...
    font_cfg.SizePixels = 17.0f;
    font_cfg.OversampleH = 3;
    font_cfg.OversampleV = 2;
    font_cfg.PixelSnapH = false;
    std::filesystem::path font_path;
    if (!g_state.root.empty()) {
      font_path = g_state.root / "content/fonts/AdwaitaSans-Regular.ttf";
    }
    ...
    } else if (std::filesystem::exists("content/fonts/AdwaitaSans-Regular.ttf")) {
      io.Fonts->AddFontFromFileTTF("content/fonts/AdwaitaSans-Regular.ttf",
  ...
  ImGui::StyleColorsDark();
  {
    ...
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.25f, 0.28f, 0.34f, 1.00f);
    ...
    colors[ImGuiCol_TabActive] = ImVec4(0.18f, 0.21f, 0.26f, 1.00f);
    ...
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.26f, 0.30f, 0.36f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.30f, 0.34f, 0.40f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.36f, 0.40f, 0.46f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.45f, 0.50f, 0.58f, 1.00f);
    colors[ImGuiCol_CheckMark] = ImVec4(0.45f, 0.72f, 0.96f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.22f, 0.25f, 0.30f, 1.00f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.34f, 0.40f, 1.00f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.36f, 0.40f, 0.46f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.22f, 0.26f, 1.00f);
    colors[ImGuiCol_TextSelectedBg] = ImVec4(0.25f, 0.45f, 0.70f, 0.35f);
  }
